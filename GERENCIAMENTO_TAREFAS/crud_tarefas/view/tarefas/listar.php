...
<div class="geral mt-2 p-5">
    <?php

    require(__DIR__ . "/../include/header.php");
    ?>

    <h3 style="color:#b84aff;" class="text-center fw-normal">Listagem de Geral</h3>
            ...
            <tbody>
                ...
                foreach ($tarefas as $t) : ?>
                    <tr>
                        ...
                        <td><?php echo $t->getProjeto()->getNome(); ?></td>
                        <td><?php echo $t->getUsuario()->getNome(); ?></td>
